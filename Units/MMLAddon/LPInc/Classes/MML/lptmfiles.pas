...
begin
  ...
  begin
    ...
    addGlobalFunc('function TMFiles.RewriteFile(Path: string; Shared: Boolean): Integer;', @TMFiles_RewriteFile);
    addGlobalFunc('function TMFiles.AppendFile(Path: string): Integer;', @TMFiles_AppendFile);
    addGlobalFunc('function TMFiles.DeleteFile(Filename: string): Boolean;', @TMFiles_DeleteFile);
    addGlobalFunc('function TMFiles.RenameFile(OldName, NewName: string): Boolean;', @TMFiles_RenameFile);
    addGlobalFunc('procedure TMFiles.CloseFile(FileNum: Integer);', @TMFiles_CloseFile);
    addGlobalFunc('procedure TMFiles.WriteINI(const Section, KeyName, NewString : string; FileName : string);', @TMFiles_WriteINI);
    addGlobalFunc('function TMFiles.ReadINI(const Section, KeyName : string; FileName : string): string;', @TMFiles_ReadINI);
    addGlobalFunc('procedure TMFiles.DeleteINI(const Section, KeyName : string; FileName : string);', @TMFiles_DeleteINI);
    addGlobalFunc('function TMFiles.EndOfFile(FileNum: Integer): Boolean;', @TMFiles_EndOfFile);
    addGlobalFunc('function TMFiles.FileSizeMuf(FileNum: Integer): LongInt;', @TMFiles_FileSizeMuf);
    addGlobalFunc('function TMFiles.ReadFileString(FileNum: Integer; out s: string; x: Integer): Boolean;', @TMFiles_ReadFileString);
    addGlobalFunc('function TMFiles.WriteFileString(FileNum: Integer;const s: string): Boolean;', @TMFiles_WriteFileString);
    addGlobalFunc('function TMFiles.SetFileCharPointer(FileNum, cChars, Origin: Integer): Integer;', @TMFiles_SetFileCharPointer);
    addGlobalFunc('function TMFiles.FilePointerPos(FileNum: Integer): Integer;', @TMFiles_FilePointerPos);
