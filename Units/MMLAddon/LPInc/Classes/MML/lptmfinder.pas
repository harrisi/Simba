...
procedure TMFinder_WarnOnly_Read(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
  Pboolean(Result)^ := PMFinder(Params^[0])^.WarnOnly;
end;

//Write: WarnOnly : boolean;
procedure TMFinder_WarnOnly_Write(const Params: PParamArray); lape_extdecl
begin
  PMFinder(Params^[0])^.WarnOnly := Pboolean(Params^[1])^;
end;

//procedure DefaultOperations(var xs,ys,xe,ye : integer);
procedure TMFinder_DefaultOperations(const Params: PParamArray); lape_extdecl
begin
...
procedure TMFinder_CountColorTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_CountColor(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_SimilarColors(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColor(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColorSpiral(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColorSpiralTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColorTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColorsTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColorsSpiralTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColors(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColoredArea(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindColoredAreaTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindMaskTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_CheckMask(const Params: PParamArray); lape_extdecl
begin
  PMFinder(Params^[0])^.CheckMask(PMask(Params^[1])^);
end;

//function FindBitmap(bitmap: TMufasaBitmap; out x, y: Integer): Boolean;
procedure TMFinder_FindBitmap(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindBitmapIn(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindBitmapToleranceIn(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindBitmapSpiral(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindBitmapSpiralTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindBitmapsSpiralTolerance(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindDeformedBitmapToleranceIn(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindDTM(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindDTMs(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindDTMRotated(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_FindDTMsRotated(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_GetColors(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
  PIntegerArray(Result)^ := PMFinder(Params^[0])^.GetColors(PPointArray(Params^[1])^);
end;

//procedure SetToleranceSpeed(nCTS: Integer);
procedure TMFinder_SetToleranceSpeed(const Params: PParamArray); lape_extdecl
begin
  PMFinder(Params^[0])^.SetToleranceSpeed(PInteger(Params^[1])^);
end;

//function GetToleranceSpeed: Integer;
procedure TMFinder_GetToleranceSpeed(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
  PInteger(Result)^ := PMFinder(Params^[0])^.GetToleranceSpeed();
end;

//procedure SetToleranceSpeed2Modifiers(const nHue, nSat: Extended);
procedure TMFinder_SetToleranceSpeed2Modifiers(const Params: PParamArray); lape_extdecl
begin
...
procedure TMFinder_GetToleranceSpeed2Modifiers(const Params: PParamArray); lape_extdecl
begin
...
procedure TMFinder_SetToleranceSpeed3Modifier(const Params: PParamArray); lape_extdecl
begin
  PMFinder(Params^[0])^.SetToleranceSpeed3Modifier(PExtended(Params^[1])^);
end;

//function GetToleranceSpeed3Modifier: Extended;
procedure TMFinder_GetToleranceSpeed3Modifier(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_Create_CTSInfo(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_Create_CTSInfoEx(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_Create_CTSInfoArray(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_Create_CTSInfo2DArray(const Params: PParamArray; const Result: Pointer); lape_extdecl
begin
...
procedure TMFinder_Init(const Params: PParamArray); lape_extdecl
begin
  PMFinder(Params^[0])^ := TMFinder.Create(PObject(Params^[1])^);
end;

//procedure Free();
procedure TMFinder_Free(const Params: PParamArray); lape_extdecl
begin
...
begin
  ...
  begin
    ...
    addGlobalFunc('function TMFinder.SimilarColors(Color1,Color2,Tolerance : Integer): boolean;', @TMFinder_SimilarColors);
    addGlobalFunc('function TMFinder.FindColor(out x, y: Integer; Color, xs, ys, xe, ye: Integer): Boolean;', @TMFinder_FindColor);
    addGlobalFunc('function TMFinder.FindColorSpiral(var x, y: Integer; color, xs, ys, xe, ye: Integer): Boolean;', @TMFinder_FindColorSpiral);
    addGlobalFunc('function TMFinder.FindColorSpiralTolerance(var x, y: Integer; color, xs, ys, xe, ye,Tol: Integer): Boolean;', @TMFinder_FindColorSpiralTolerance);
    addGlobalFunc('function TMFinder.FindColorTolerance(out x, y: Integer; Color, xs, ys, xe, ye, tol: Integer): Boolean;', @TMFinder_FindColorTolerance);
    addGlobalFunc('function TMFinder.FindColorsTolerance(out Points: TPointArray; Color, xs, ys, xe, ye, Tol: Integer): Boolean;', @TMFinder_FindColorsTolerance);
    addGlobalFunc('function TMFinder.FindColorsSpiralTolerance(x, y: Integer; out Points: TPointArray; color, xs, ys, xe, ye: Integer; Tol: Integer): boolean;', @TMFinder_FindColorsSpiralTolerance);
    addGlobalFunc('function TMFinder.FindColors(var TPA: TPointArray; Color, xs, ys, xe, ye: Integer): Boolean;', @TMFinder_FindColors);
    addGlobalFunc('function TMFinder.FindColoredArea(var x, y: Integer; color, xs, ys, xe, ye: Integer; MinArea: Integer): Boolean;', @TMFinder_FindColoredArea);
    addGlobalFunc('function TMFinder.FindColoredAreaTolerance(var x, y: Integer; color, xs, ys, xe, ye: Integer; MinArea, tol: Integer): Boolean;', @TMFinder_FindColoredAreaTolerance);
    addGlobalFunc('function TMFinder.FindMaskTolerance(const mask: TMask; out x, y: Integer; xs, ys, xe, ye: Integer; Tolerance, ContourTolerance: Integer): Boolean;', @TMFinder_FindMaskTolerance);
    addGlobalFunc('procedure TMFinder.CheckMask(const Mask : TMask);', @TMFinder_CheckMask);
    addGlobalFunc('function TMFinder.FindBitmap(bitmap: TMufasaBitmap; out x, y: Integer): Boolean;', @TMFinder_FindBitmap);
    addGlobalFunc('function TMFinder.FindBitmapIn(bitmap: TMufasaBitmap; out x, y: Integer;  xs, ys, xe, ye: Integer): Boolean;', @TMFinder_FindBitmapIn);
    addGlobalFunc('function TMFinder.FindBitmapToleranceIn(bitmap: TMufasaBitmap; out x, y: Integer; xs, ys, xe, ye: Integer; tolerance: Integer): Boolean;', @TMFinder_FindBitmapToleranceIn);
    addGlobalFunc('function TMFinder.FindBitmapSpiral(bitmap: TMufasaBitmap; var x, y: Integer; xs, ys, xe, ye: Integer): Boolean;', @TMFinder_FindBitmapSpiral);
    addGlobalFunc('function TMFinder.FindBitmapSpiralTolerance(bitmap: TMufasaBitmap; var x, y: Integer; xs, ys, xe, ye,tolerance : integer): Boolean;', @TMFinder_FindBitmapSpiralTolerance);
    addGlobalFunc('function TMFinder.FindBitmapsSpiralTolerance(bitmap: TMufasaBitmap; x, y: Integer; out Points : TPointArray; xs, ys, xe, ye,tolerance: Integer; maxToFind: Integer = 0): Boolean;', @TMFinder_FindBitmapsSpiralTolerance);
    addGlobalFunc('function TMFinder.FindDeformedBitmapToleranceIn(bitmap: TMufasaBitmap; out x, y: Integer; xs, ys, xe, ye: Integer; tolerance: Integer; Range: Integer; AllowPartialAccuracy: Boolean; out accuracy: Extended): Boolean;', @TMFinder_FindDeformedBitmapToleranceIn);
    addGlobalFunc('function TMFinder.FindDTM(DTM: TMDTM; out x, y: Integer; x1, y1, x2, y2: Integer): Boolean;', @TMFinder_FindDTM);
    addGlobalFunc('function TMFinder.FindDTMs(DTM: TMDTM; out Points: TPointArray; x1, y1, x2, y2 : integer; maxToFind: Integer = 0): Boolean;', @TMFinder_FindDTMs);
    addGlobalFunc('function TMFinder.FindDTMRotated(DTM: TMDTM; out x, y: Integer; x1, y1, x2, y2: Integer; sAngle, eAngle, aStep: Extended; out aFound: Extended; Alternating : boolean): Boolean;', @TMFinder_FindDTMRotated);
    addGlobalFunc('function TMFinder.FindDTMsRotated(DTM: TMDTM; out Points: TPointArray; x1, y1, x2, y2: Integer; sAngle, eAngle, aStep: Extended; out aFound: T2DExtendedArray;Alternating : boolean; maxToFind: Integer = 0): Boolean;', @TMFinder_FindDTMsRotated);
    addGlobalFunc('function TMFinder.GetColors(const Coords: TPointArray): TIntegerArray;', @TMFinder_GetColors);
    addGlobalFunc('procedure TMFinder.SetToleranceSpeed(nCTS: Integer);', @TMFinder_SetToleranceSpeed);
    addGlobalFunc('function TMFinder.GetToleranceSpeed(): Integer;', @TMFinder_GetToleranceSpeed);
    addGlobalFunc('procedure TMFinder.SetToleranceSpeed2Modifiers(const nHue, nSat: Extended);', @TMFinder_SetToleranceSpeed2Modifiers);
    addGlobalFunc('procedure TMFinder.GetToleranceSpeed2Modifiers(out hMod, sMod: Extended);', @TMFinder_GetToleranceSpeed2Modifiers);
    addGlobalFunc('procedure TMFinder.SetToleranceSpeed3Modifier(modifier: Extended);', @TMFinder_SetToleranceSpeed3Modifier);
    addGlobalFunc('function TMFinder.GetToleranceSpeed3Modifier(): Extended;', @TMFinder_GetToleranceSpeed3Modifier);
    addGlobalFunc('function TMFinder.Create_CTSInfo(Color, Tolerance: Integer): Pointer;', @TMFinder_Create_CTSInfo);
    addGlobalFunc('function TMFinder.Create_CTSInfo(R, G, B, Tolerance: Integer): Pointer; overload;', @TMFinder_Create_CTSInfoEx);
    addGlobalFunc('function TMFinder.Create_CTSInfoArray(color, tolerance: array of integer): TCTSInfoArray;', @TMFinder_Create_CTSInfoArray);
    addGlobalFunc('function TMFinder.Create_CTSInfo2DArray(w, h: integer; data: TPRGB32Array; Tolerance: Integer): TCTSInfo2DArray;', @TMFinder_Create_CTSInfo2DArray);
